...
> 配套 design / sign-off 文档: [`docs/protocol/ENVELOPE-SCHEMA-FREEZE.md`](../ENVELOPE-SCHEMA-FREEZE.md).
...
本 V1 spec 签字栏见 [`docs/protocol/ENVELOPE-SCHEMA-FREEZE.md` §9](../ENVELOPE-SCHEMA-FREEZE.md#9-sign-off-%E6%A0%8F-5-owner)。
