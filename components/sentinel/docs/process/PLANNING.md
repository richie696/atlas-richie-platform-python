...
- **子任务**：
  ...
  - [x] M6.3.1 协议 V1 frozen — `docs/protocol/集群令牌协议.md` (6 message_kind, 8+1 envelope, opaque lease identity, owner epoch fencing, idempotency request_id, V1 兼容性矩阵)
...
- **子任务**：
  - [ ] M6.5.1 先完成 `docs/protocol/事件上报协议.md`：冻结 V1 schema、
...
- **V1 冻结** (M6.5.7 envelope freeze, 2026-09-13):
  - `docs/protocol/事件上报协议.md` V1 schema 冻结 (8 字段
    envelope + 6 个 event_kind + per-kind frozen payload + V1 兼容性矩阵)
  - `docs/protocol/事件包冻结.md` design + 5 owner sign-off doc
